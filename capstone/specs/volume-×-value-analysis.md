...
| ADR-6 | Clinical summaries requiring supplementation by clinical admin before physician review (~10% of Clinical Path volume) | 21,000/yr × 10 min × $31.25/hr | $109,375 |
| ADR-9 | Phase 2 human sign-off on AI denial letters (MT-9.1) | 83,250/yr × 2 min × $31.25/hr | $86,979 |
| **Total HITL** | | | **$765,104** |

**ADR-6 HITL note:** ADR-6 has no admin baseline (clinical pre-screening is currently performed by physicians, not admin processors — the admin cost table correctly excludes it). The $109,375 HITL is a net new cost representing cases where the AI-generated summary has low confidence and requires clinical admin supplementation before physician review. The offsetting value from ADR-6 is captured in the physician capacity multiplier [A5] under Additional Value below.

**Total annual agent cost: $40,500 + $765,104 = $805,604/year**

### Build Cost and ROI

| Component | Wave | Estimated Build Cost |
|-----------|:----:|--------------------:|
| ADR-4: Clinical triage shadow mode + classification model infrastructure [A9] | Wave 1 | $90,000 |
| ADR-1: EDI intake pipeline + PDF extraction module | Wave 1 | $35,000 |
| ADR-3: Rules engine wrap + LLM plausibility layer | Wave 2 | $25,000 |
| ADR-2: Eligibility API integration (multi-system) | Wave 2 | $40,000 |
| ADR-5: Fast Path adjudication engine + approval/denial workflow | Wave 2 | $65,000 |
| ADR-6: Clinical pre-screening + physician summary portal [A20] | Wave 2 | $75,000 |
| ADR-9: Denial letter generation + policy citation integration [A18] | Wave 3 | $45,000 |
| ADR-8: Payment engine integration (trigger existing system) | Wave 3 | $15,000 |
...
Annual agent cost (API + HITL):         $805,604
                                      ----------
Annual saving:                          $494,396

Build cost:                             $400,000
Payback period:                         9.7 months

Year 1 ROI:  ($494,396 - $400,000) / $400,000 =   24%
3-year ROI:  ($494,396 × 3 - $400,000) / $400,000 = 271%
```
...
**CFO alignment — primary metric:** The stakeholder agreement commits to a net 13 FTE headcount reduction (20 → 7 admin processors) by Month 6, representing $845K/year in gross labor savings. This reduction is delivered when ADR-5 goes live in Wave 2 — it is not contingent on Wave 3. The base-case annual saving of $494K closes after deducting full agent running costs; the gross FTE savings alone exceed the $400K build cost within the first operating year. SLA penalty avoidance [A8] and physician hiring avoidance [A5, A23] are additive to this base case and are not required for the model to close. HITL cost assumptions [A21] will be validated and refined against Phase 1 time-motion data before Phase 2 staffing reductions are finalized — if exception volumes are lower than estimated, the saving improves; the 13 FTE reduction target is independent of HITL volume.
