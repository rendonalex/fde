...
The brief below is your **starting context**. Like a real client engagement, the named stakeholder knows things this document doesn't tell you. Your coach role-plays the stakeholder during the week — at office hours, the mid-week checkpoint, and ad-hoc squad interactions.

Bring **specific, design-changing questions** to those interactions. Generic questions ("walk me through your typical day") will get generic answers. Precise questions about lived practice, prior automation history, system edge cases, and stakeholder priorities will earn substantive responses.

**Eliciting what's not in the brief is the Week 2 skill.** This document gives you enough to start; it deliberately does not give you everything you need to finish.

Each scenario also includes **3 sample artefacts** — fragments of how the work actually happens (calls, emails, system extracts, sticky-note margins). They exist so your "lived work" claims are grounded in evidence rather than narration. Mine them. Then use coach interactions to surface what the artefacts hint at but don't spell out, and to test the assumptions you've made from them.

If you find yourself producing a Cognitive Load Map purely from the brief without referencing artefacts or coach-elicited material, you are skipping the work.
...
Bring questions to your coach (role-playing Lara) about:
...
Bring questions to your coach (role-playing Tom) about:
...
Bring questions to your coach (role-playing Eleanor) about:
...
Bring questions to your coach (role-playing Marcus) about:
