...
**Wave 1 economic summary (8-week MVP)** *[Rev. 2026-05-13 — CEO Pushback]*: Year 1 return ranges from ~$466K (floor: labor savings only, no revenue recovery from A5) to ~$1.85M (ceiling: labor savings + $1.5M M3 revenue recovery at A5=30%). In all A5 scenarios, the engagement is cash-flow positive within 4.2 months from labor savings alone. Year 1 ROI floor: ~188%; ceiling: ~1,440%.

**Scale comparison for the CFO**: Without automation, reaching the $200M 24-month revenue target requires scaling coordinator headcount from 8 to approximately 112 at current per-coordinator throughput (A1, A4). At $55K/year fully loaded (A7), that is ~$5.7M in additional annual coordinator cost. The agentic pipeline eliminates this headcount scaling requirement entirely. The relevant comparison is not "$120K build vs. ROI percentage" — it is "$120K build vs. $5.7M headcount."
...
Economics:
  ...
  Revenue recovery scenarios (A5 falsifiable check): *[Rev. 2026-05-13 — CEO Pushback]*
  | Scenario | A5 win-loss rate | 6-month M3 target | Year 1 total (labor + M3) | Year 1 ROI |
  |---|---|---|---|---|
  | Ceiling (A5=30%) | Win rate ≤75% | $1.5M | ~$1.85M | ~1,440% |
  | Midpoint (A5=10%) | Win rate 75–90% | $375K–$500K | ~$721K–$846K | ~490%–604% |
  | Floor (A5=0%) | Win rate >90% | $0 (speed not the lever) | ~$346K | ~188% |
  All scenarios cash-flow positive; payback <4.2 months from labor savings (A7, A21).
  Floor case: replace M3 with throughput-scaling metric if win rate >90% confirmed at week 2.
...
Economics:
  ...
  Primary value: enables M4 no-show tracking baseline and closes the initial confirmation loop (A14 dependency)
  *Wave 1 scope (MT-5.1/5.2 only):* Hospital response monitoring + initial nurse placement notification. Proactive T-48h/T-24h nurse confirmation (Feature 5, Shift Confirmation Notifier) is deferred to Wave 2 pending U4 resolution. *[Rev. 2026-05-13 — CEO Pushback]*

Delegation archetype: Fully Agentic (MT-5.1/5.2); Feature 5 proactive confirmation deferred to Wave 2
```
...
**Parallel development note** *[Rev. 2026-05-13 — CEO Pushback]*: JtD-3 ranker data model design begins in week 1 simultaneously with JtD-1 parser development. This requires the parser output schema to be locked at end of week 1 (see `specs/03-agentic-solution-architecture.md` Section 3.1). The ranker builds against the locked schema as a stable interface — it does not wait for the parser to be complete.
...
| Feature 5 (JtD-5 proactive confirmation) | Proactive T-48h/T-24h nurse confirmation (Shift Confirmation Notifier) *[Rev. 2026-05-13 — CEO Pushback]* | U4 (bidirectional notification infrastructure) must be resolved; MT-5.1/5.2 Wave 1 notification infrastructure reused |
...
| 4 | JtD-5a | Monitoring & Notification (MT-5.1/5.2 only) | 4 | 25 | Pass | 1 | Fully Agentic | Wave 1: hospital response monitoring + initial nurse notification only. Feature 5 proactive confirmation deferred Wave 2 (U4 unresolved). *[Rev. 2026-05-13 — CEO Pushback]* |
